...
{
    dates: [ d(1997), d(2001​) ],
    content:`_1997 – 2001​: attentats terroristes_
...
{
    dates: [ d(2001), d(2004​) ],
    content:`_2001 – 2004​: Le 11 septembre et ses conséquences (Afghanistan, Irak, politisation du débat sur l’islam)_
...
{
    dates: [ d(2005), d(2007) ],
    content:`_2005 – 2007: Contexte international tendu, malaise  croissant en France._
...
{
    dates: [ d(2009), d(2010) ],
    content:`_2009 – 2010: Un “problème” Français_
...
{
    dates: [ d(2011), d(2013) ],
    content:`_2011 – 2013: Printemps arabes, hivers islamistes. La France en guerres_
...
{
    dates: [ d(2014), d(2015) ],
    content:`_2014 – 2015: Etat Islamique et attentats en Europe_
